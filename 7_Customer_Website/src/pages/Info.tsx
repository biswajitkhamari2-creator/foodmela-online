...
const PAGES: Record<string, InfoPage> = {
  ...
  terms: {
    ...
    body: [
      ...
      '7. STATUTORY GRIEVANCE REDRESSAL: In compliance with Rule 5(3)(b) of the Consumer Protection (E-Commerce) Rules, 2020, our Grievance Officer is Biswajit Khamari (Birmaharajpur, Subarnapur, Odisha - 767018, Phone: 8144503650, Email: support@foodmela.online). Complaints are acknowledged within 48 hours and resolved within 30 days.',
